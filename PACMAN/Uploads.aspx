    ...
    <div id="DropBox" class="box box-primary box-solid">
        ...
        <div class="box-body needsclick">
            <div class="table table-striped files needsclick" id="previews">
                <div id="template" class="file-row  needsclick">
                    <!-- This is used as the file preview template -->
                    <div>
                        <span class="preview  needsclick">
                            <img data-dz-thumbnail /></span>
                    </div>
                    <div>
                        <p class="name  needsclick" data-dz-name></p>
                        <strong class="error text-danger  needsclick" data-dz-errormessage></strong>
                    </div>
                    <div>
                        <p class="size  needsclick" data-dz-size></p>
                        <div class="progress progress-striped active  needsclick" role="progressbar" aria-valuemin="0" aria-valuemax="100" aria-valuenow="0">
                            <div class="progress-bar progress-bar-success  needsclick" style="width: 0%;" data-dz-uploadprogress></div>
                        </div>
                    </div>
                    <div>
                        <button class="btn btn-primary start  needsclick">
                            <i class="glyphicon glyphicon-upload"></i>
                            <span>Start</span>
                        </button>
                        <button data-dz-remove class="btn btn-warning cancel  needsclick">
                            <i class="glyphicon glyphicon-ban-circle"></i>
                            <span>Cancel</span>
                        </button>
                        <button data-dz-remove class="btn btn-danger delete  needsclick">
