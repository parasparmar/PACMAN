...
<asp:Content ID="Content4" ContentPlaceHolderID="pageheader" runat="Server">
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="movement.aspx"><i class="fa fa-flag-o"></i>Escalations & Initiatives</a></li>
    </ol>
...
<asp:Content ID="Content5" ContentPlaceHolderID="The_Body" runat="Server">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" EnableViewState="true" UpdateMode="Conditional">
        <ContentTemplate>
                ...
                <div class="col-lg-6">
                    <div class="box box-solid box-success">
                        <div class="box-header">
                            ...
                            <h3 class="box-title pull-right">Score:
                                <asp:Label ID="lblInitiativeScoreTop" runat="server"></asp:Label></h3>
                            </h3>
                        </div>
                        <div class="box-body">
                            <div class="form-group">
                            ...
                            <div class="pull-right">
                                ...
                                &nbsp
                        <asp:Button ID="btnSaveIni" runat="server" Text="Save" CssClass="btn btn-primary" OnClick="btnSaveIni_Click" />
                            </div>
                            <br>
                            <br>
                            <br>
            ...
            <div class="box-footer clearfix no-border">
                <div class="box box-primary">
                    <h3>Total combined score for Escalation and Initiative is <asp:Label ID="lblTotalScore" runat="server"></asp:Label></h3>
                </div>
            </div>
            <%--    </div>
