...
<%--    <asp:UpdatePanel ID="UpdatePanel1" runat="server" EnableViewState="true" UpdateMode="Conditional">
        <ContentTemplate>--%>
            ...
            <div class="box box-solid box-primary" style="height: auto;">
                ...
                <div class="box-body">
                    <div class="form-group">
                        <asp:GridView ID="gv_EmpList" runat="server" CssClass="GraceDataTable table table-condensed table-responsive display compact hover stripe" AutoGenerateColumns="false"
